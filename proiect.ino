...
LiquidCrystal lcd(1, 2, 4, 5, 6, 7); // Creez un obiect de tip LCD. Parametrii: (rs, enable, d4, d5, d6, d7)
const int trigPin = 9;
...
void loop() {
  ...
  if(distance >= 5){
    ...
    digitalWrite(pumpPin, HIGH); //Pornesc pompa de apa
    delay(800);
    digitalWrite(pumpPin, LOW); //Opresc pompa de apa
    delay(10);
